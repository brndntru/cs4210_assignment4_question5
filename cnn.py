...
# FILENAME: cnn.py
# SPECIFICATION: This program implements a Convolutional Neural Network (CNN) to classify 32x32 images of handwritten digits using the dataset and printing the test accuracy.
...
train_path = os.path.join("assignment4/digit_dataset", "train")
test_path = os.path.join("assignment4/digit_dataset", "test")
